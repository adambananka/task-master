...
/**
 * Dialect extension necessary for work with SQLite database, which is not
 * supported by Spring and Hibernate by default.
 *
 * @author Adam Baňanka
 */
public class SQLiteDialect extends Dialect {
  ...
  @Override
  public String getAddForeignKeyConstraintString(String cn, String[] fk,
      String t, String[] pk, boolean rpk) {
    return "";
  }
